...
x-environment: &environment
  environment:
    ...
    ```yaml
        # Uncomment the below and set to 1 if you want to enable Google OAuth
        # GOOGLE_AUTH_ENABLED: This variable enables Google authentication in your application.
        # GOOGLE_CLIENT_ID: This is the client ID you receive from Google when you register your application.
        # GOOGLE_CLIENT_SECRET: This is the client secret you receive from Google. It should be kept private.
    ```
</Col>
